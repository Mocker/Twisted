...
class titleController:
	...
	def render(self, escreen):
		...
		escreen.blit(tmptext, [500, 400])
		tmptext = self.font.render("Load Bizness < " + self.level_list[self.level_index]+" >",1,(250,250,250))
		escreen.blit(tmptext, [500, 450])
		tmptext = self.font.render(self.text_exit,1,(250,250,250))
		escreen.blit(tmptext, [500, 500])
